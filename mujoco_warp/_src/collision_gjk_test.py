...
def _geom_dist(
  ...
  def _gjk_kernel(
    ...
    dist, ncon, x1, x2 = wp.static(ccd(multiccd, m.opt.ccd_iterations, m.nmaxpolygon, m.nmaxmeshdeg))(
      tolerance[0], 1.0e30, geom1, geom2, geomtype1, geomtype2, geom1.pos, geom2.pos
    )
  ...
  wp.launch(
    ...
    outputs=[dist_out, ncon_out, pos_out],
  )
