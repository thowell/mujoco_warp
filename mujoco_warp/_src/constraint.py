...
def _efc_equality_connect(
  ...
  for i in range(3):
    ...
    _update_efc_row(
      ...
      Jqvel[i],
      0.0,
      int(ConstraintType.EQUALITY.value),
      i_eq,
      efc_type_out,
      efc_id_out,
      efc_pos_out,
...
def _efc_friction_dof(
  ...
  _update_efc_row(
    ...
    int(ConstraintType.FRICTION_DOF.value),
    dofid,
    efc_type_out,
    efc_id_out,
    efc_pos_out,
...
def _efc_friction_tendon(
  ...
  _update_efc_row(
    ...
    Jqvel,
    frictionloss,
    int(ConstraintType.FRICTION_TENDON.value),
    tenid,
    efc_type_out,
    efc_id_out,
    efc_pos_out,
...
def _efc_limit_slide_hinge(
  ...
  if active:
    ...
    _update_efc_row(
      ...
      Jqvel,
      0.0,
      int(ConstraintType.LIMIT_JOINT.value),
      dofadr,
      efc_type_out,
      efc_id_out,
      efc_pos_out,
...
def _efc_limit_tendon(
  ...
  if active:
    ...
    _update_efc_row(
      ...
      Jqvel,
      0.0,
      int(ConstraintType.LIMIT_TENDON.value),
      tenid,
      efc_type_out,
      efc_id_out,
      efc_pos_out,
