...
class Model:
  ...
  flex_dim: wp.array(dtype=int, ndim=1)
  flex_vertadr: wp.array(dtype=int, ndim=1)
  flex_vertnum: wp.array(dtype=int, ndim=1)
  flex_edgeadr: wp.array(dtype=int, ndim=1)
  flex_elemedgeadr: wp.array(dtype=int, ndim=1)
  flex_vertbodyid: wp.array(dtype=int, ndim=1)
  flex_edge: wp.array(dtype=wp.vec2i, ndim=1)
  flex_elem: wp.array(dtype=int, ndim=1)
  flex_elemedge: wp.array(dtype=int, ndim=1)
  flexedge_length0: wp.array(dtype=float, ndim=1)
  flex_stiffness: wp.array(dtype=float, ndim=1)
  flex_damping: wp.array(dtype=float, ndim=1)
...
class Data:
  ...
  flexedge_length: wp.array(dtype=float, ndim=2)
  flexedge_velocity: wp.array(dtype=float, ndim=2)
